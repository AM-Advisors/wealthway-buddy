...
export const CAPABILITY_MIN_AUTHORITY: Record<DelegationCapability, AuthorityLevel> = {
  ...
  view_tax_returns: "view",
  // Preparing, reviewing, requesting information, delivering a return and
  // keeping workpapers are all assist-level work. None of them carries filing
  // authority, signing authority or any authority to move money.
  prepare_entity_return: "assist",
  review_entity_return: "assist",
  prepare_individual_return: "assist",
  review_individual_return: "assist",
  request_tax_information: "assist",
  deliver_tax_return: "assist",
  manage_tax_workpapers: "assist",
