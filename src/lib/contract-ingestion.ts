...
export const TERM_CATALOG: TermDef[] = [
  ...
  { key: "termination_type", category: "Termination", label: "Termination type (for cause / convenience)", material: false },
  { key: "notice_delivery_method", category: "Termination", label: "Required notice delivery method", material: false },
  { key: "notice_recipient", category: "Termination", label: "Notice recipient / address / email", material: false },
  { key: "liability_summary", category: "Liability / Indemnification", label: "Liability & indemnification (reference only)", material: false },
  { key: "indemnification", category: "Liability / Indemnification", label: "Indemnification (reference only)", material: false },
  { key: "confidentiality", category: "Legal", label: "Confidentiality (reference only)", material: false },
  { key: "governing_law", category: "Legal", label: "Governing law", material: false },
  { key: "dispute_resolution", category: "Legal", label: "Dispute resolution / arbitration", material: false },
  { key: "assignment", category: "Legal", label: "Assignment", material: false },
  { key: "subcontractors", category: "Legal", label: "Subcontractors / third parties", material: false },
