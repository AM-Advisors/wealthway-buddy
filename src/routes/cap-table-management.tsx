...
export const Route = createFileRoute("/cap-table-management")({
  head: () =>
    marketingHead({
      path: "/cap-table-management",
      title: "Cap Table Management & Migration | Harmonious",
      description: "Manage your cap table in Harmonious: stakeholders, security classes, issuances, transactions and ownership, with migration from spreadsheets and other systems.",
      image: "https://onboard.harmonious.co/og-harmonious.jpg",
      breadcrumbs: [{ name: "Home", path: "/" }, { name: "Cap Table Management", path: "/cap-table-management" }],
      service: { name: "Cap Table Management", description: "Cap table records, stakeholders, securities and ownership tracking." },
    }),
